...
public protocol ChatRepository {
    ...
    func sendAudioMessage(chatID: UUID, audioData: Data, localID: UUID?) async throws -> Message
...
public extension ChatRepository {
    func sendAudioMessage(chatID: UUID, audioData: Data, localID: UUID?) async throws -> Message {
        throw AppError.network(description: "Голосовые сообщения не поддерживаются этим репозиторием")
    }
}
