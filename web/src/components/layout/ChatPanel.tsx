...
export function ChatPanel({
  ...
  return (
    <section className="flex h-full min-h-0 flex-col overflow-hidden rounded-[30px] border border-white/10 bg-white/[0.06] backdrop-blur-2xl">
      ...
      <div className="min-h-0 flex-1 bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.08),_transparent_36%),linear-gradient(180deg,rgba(15,23,42,0.3),rgba(2,6,23,0.12))]">
        <MessageList
          messages={messages}
