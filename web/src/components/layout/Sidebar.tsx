...
export function Sidebar({
  ...
  return (
    <aside className="messenger-sidebar flex h-full min-h-0 flex-col">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div className="relative">
              ...
              {isMenuOpen ? (
                <div className="mobile-sheet-shadow absolute right-0 top-full z-20 mt-2 w-[min(310px,calc(100vw-2rem))] rounded-[20px] border border-white/10 bg-[#0b1420]/96 p-3 shadow-[0_26px_70px_rgba(3,8,20,0.48)] backdrop-blur-2xl">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-2 py-2 overscroll-contain sm:px-3">
        {activeTab === "chats" ? (
          <ChatList
            chats={filteredChats}
            ...
            <div className="rounded-[18px] border border-white/8 bg-white/[0.03] p-3">
              <div className="flex gap-2">
                <Input
                  ...
                  className="h-11 rounded-[14px] border-white/8 bg-slate-950/72 text-[16px] sm:text-sm"
                />
                <Button
